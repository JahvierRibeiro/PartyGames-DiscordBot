...
const pagination = async (options) => {
    ...
    const numberTravel = async () => {
        ...
        const numberTravelMessage = await message.channel.send(`${message.author.tag}, you have 30 seconds, send numbers in chat to change pages! Simply type \`end\` to exit from page travelling.`);
